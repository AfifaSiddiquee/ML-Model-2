...
st.markdown(
    "<p style='text-align: center; font-size: 18px;'>📝 Curious about what a review really says? "
    "Enter any product review, and SentimentScope Analyzer will instantly classify its sentiment as Positive, Neutral, or Negative—"
    "helping you make informed decisions in seconds!</p>",
    unsafe_allow_html=True
)
...
if st.button("Analyze Sentiment"):
    if review:
        ...
        # Ensure the prediction is lowercase and stripped of extra spaces
        prediction = model.predict(review_tfidf)[0]
